...
//    private String[] PMNNA = new String[]     {"PAMNNA", datos_mpales[0], datos_mpales[1], datos_mpales[2],datos_mpales[3], datos_mpales[4], datos_mpales[5]};
//    private String[] MPALES = new String[] {"DEL. MPALES", datos_mpales[0], datos_mpales[1], datos_mpales[2],datos_mpales[3], datos_mpales[4], datos_mpales[5]};

//    private String[] PRIMERAVEZ_T2 = new String[]  {"1ERA VEZ", datos_primera_t2[0], datos_primera_t2[1], datos_primera_t2[2], datos_primera_t2[3], datos_primera_t2[4], datos_primera_t2[5],datos_primera_t2[6], datos_primera_t2[7], datos_primera_t2[8]};
//    private String[] SUBSECUENTE_T2 = new String[] {"SUBSECUENTE", datos_segunda_t2[0], datos_segunda_t2[1], datos_segunda_t2[2], datos_segunda_t2[3], datos_segunda_t2[4], datos_segunda_t2[5],datos_segunda_t2[6], datos_segunda_t2[7], datos_segunda_t2[8]};
//    private String[] SEGUIMIENTO_T2 = new String[] {"SEGUIMIENTO", datos_tercera_t2[0], datos_tercera_t2[1], datos_tercera_t2[2], datos_tercera_t2[3], datos_tercera_t2[4], datos_tercera_t2[5],datos_tercera_t2[6], datos_tercera_t2[7], datos_tercera_t2[8]};

//    private String[] PRIMERAVEZ_T3 = {"1ERA VEZ", datos_primera_t3[0], datos_primera_t3[1], datos_primera_t3[2], datos_primera_t3[3], datos_primera_t3[4], datos_primera_t3[5],datos_primera_t3[6], datos_primera_t3[7], datos_primera_t3[8]};
//    private String[] SUBSECUENTE_T3 = {"SUBSECUENTE", datos_segunda_t3[0], datos_segunda_t3[1], datos_segunda_t3[2], datos_segunda_t3[3], datos_segunda_t3[4], datos_segunda_t3[5],datos_segunda_t3[6], datos_segunda_t3[7], datos_segunda_t3[8]};
//    private String[] SEGUIMIENTO_T3 = {"SEGUIMIENTO", datos_tercera_t3[0], datos_tercera_t3[1], datos_tercera_t3[2], datos_tercera_t3[3], datos_tercera_t3[4], datos_tercera_t3[5],datos_tercera_t3[6], datos_tercera_t3[7], datos_tercera_t3[8]};
