...
public class EstadisticaAsistenciaSocialPDF {
    ...
    public EstadisticaAsistenciaSocialPDF (String nombre_reporte, String url_reporte, EstadisticaTrabajoSocialData data, String periodo, TrabajadorData d) throws IOException, DocumentException {
        ...
        document.add(Default.generarTabla(new String[] {"", "NIÑAS", "NIÑOS", "DESCONOCIDO", "TOTAL INGRESOS"}, data.getIngresos_centros()));
        document.add(Default.generarTabla(new String[] {"", "NIÑAS", "NIÑOS", "DESCONOCIDO", "TOTAL EGRESOS"}, data.getEgresos_centros()));
    ...
    public PdfPTable getTitle() {
        ...
        content.addCell(Default.celda());
        content.addCell(Default.celda("INGRESOS Y EGRESOS A CENTROS DE ASISTENCIA SOCIAL", Default.TITULO, Element.ALIGN_CENTER));
